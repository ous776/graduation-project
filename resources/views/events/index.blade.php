                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" style="width: 570px; height:450px; white-space: nowrap; overflow-x: scroll;">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <form method="POST" class="post-text ms-3 w-100" action="{{route('events.store')}}" enctype="multipart/form-data">
                                                                @csrf
                                            ...
                                            <div class="post-item">
                                                <div class="user-post-data pb-3">
                                                    <div class="d-flex justify-content-between">
                                                        <div class="me-3">
                                                            <img class="rounded-circle  avatar-60" src="{{$event->author->profile_photo_url}}" alt="" loading="lazy">
                                                        </div>
                                                        <div class="w-100">
                                                            <div class="d-flex justify-content-between flex-wrap">
                                                                <div class=""><br>
                                                                    <h5 class="mb-0 d-inline-block"><a href="#" class="">{{$event->author->full_name}}</a></h5>
                                                                </div>
                                                ...
                                                <div class="user-post">
                                                    <h3>{{$event->title}}</h3>
                                                    <p>{{$event->message_content}}</p>
                                                </div>
                                                @if($event->image)
                                                <div class="user-post">
                                                    <div class=" d-grid grid-rows-2 grid-flow-col gap-3">
                                                        @foreach(json_decode($event->image,true) as $image)
