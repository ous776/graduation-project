                        ...
                        <div id="post-modal-data" class="card card-block">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="user-img">
                                        <img src="{{ $group->photo ? url('/storage/'. $group->photo) : '../assets/images/page-img/pp.png'}}" alt="userimg" class="avatar-60 rounded-circle">
                                    </div>
                                ...
                                <div class="modal-dialog   modal-fullscreen-sm-down">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="width: 570px; height:450px; white-space: nowrap; overflow-x: scroll;">
                                            <form method="POST" class="post-text ms-3 w-100" action="{{route('posts.store')}}?route=group-detail&gId={{$group->id}}" enctype="multipart/form-data">
                                                <div class="d-flex align-items-center">
                                                    <div class="user-img">
                                                        <img src="{{ $group->photo ? url('/storage/'. $group->photo) : '../assets/images/page-img/pp.png'}}" alt="userimg" class="avatar-60 rounded-circle img-fluid">
                                                    </div>
                                                    @csrf
                                                    <input name="message" type="text" class="form-control rounded" placeholder="Write something here..." style="border:none;">
                                                    <ul class="d-flex flex-wrap align-items-center list-inline m-0 p-0">
                                                        <li class="col-md-6 mb-3"></li>
                                                        <div class="container">
                                ...
                                <div class="post-item">
                                    <div class="user-post-data pb-3">
                                        <div class="d-flex justify-content-between">
                                            <div class="me-3">
                                                <img class="rounded-circle avatar-60" src="{{$post->user->profile_photo_url}}" alt="" loading="lazy">
                                            </div>
                                            <div class="w-100">
                                                <div class="d-flex justify-content-between flex-wrap">
                                                    <div class=""><br>
                                                        <h5 class="mb-0 d-inline-block"><a href="#" class="">{{$post->user->full_name}}</a></h5>
                                                    </div>
                                                    <div class="card-post-toolbar">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu m-0 p-0">
                                                                <form id="post-delete-{{ $post->id }}" method="post" action="{{ route('delete-post', $post->id) }}?route=group-detail&gId={{ $group->id }}">
                                                                    @csrf
                                                                    @method('delete')
                                                                    <a href="javascript:;" class="dropdown-item p-3" onclick="document.getElementById('post-delete-{{ $post->id }}').submit()">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="data ms-2">
                                                                                <h6>Delete Post</h6>
                                                                                <p class="mb-0">Delete this from timeline</p>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                                                </form>
